...
root.title('Rushabh Contact Book')
root.resizable(0,0)
contactlist = [
    ['Satish','9185756478'],
    ['Gaurav Darji', '9175676478'],
    ['Abhishek Pandey', '9188756478'],
    ['Sakshi Joshi', '9188776078'],
    ['Maharshi Dave', '9185755077'],
    ['Karan Patel', '9185756490'],
    ['Sameer Patel', '9185756859'],
    ['Naimesh Patel', '9185786478'],
    ['Arun Bhabhaniya','9185776478']
    ]
...
Button(root,text="EXIT", font='Helvetica 24 bold',bg='tomato', command = EXIT).place(x= 235, y=480)
